...
class Object implements ArrayAccess
{
    ...
    public static function init()
    {
        ...
        self::$nestedUpdatableAttributes = new Set(array('metadata'));
    }
    ...
    public function refreshFrom($values, $opts, $partial = false)
    {
        ...
        foreach ($values as $k => $v) {
            ...
            if (self::$nestedUpdatableAttributes->includes($k) && is_object($v))
                ...
                $this->_values[$k] = Util::convertToPingppObject($v, $opts);
    ...
    {
        if ($recursive)
            return Util::convertPingppObjectToArray($this->_values);
        else
            return $this->_values;
    }
    ...
    {
        return Util::convertPingppObjectToStdObject($this->_values);
    }
}
